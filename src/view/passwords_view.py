...
class RecordsWindow(ctk.CTkToplevel):
    ...
    def __init__(self, controller, table_wid, headers):
        ...
        self.gen_pass_btn.place(anchor="c", relx=0.43, rely=0.1035)
...
class PassMKFrame(ctk.CTkFrame):
    ...
    def confirm_btn_com(self):
        if self.new_MK:
            ...
            self.controller.passwords_display_frame.menu_bar.menubar.entryconfig(
    ...
    def pop_up_window(self, msg_text, text_color, win_title):
        ...
        ok_button = ctk.CTkButton(
            pop_up_window, text="OK", command=lambda: self.close_pop_up(pop_up_window)
        )
        ok_button.pack(pady=10)

    def close_pop_up(self, pop_up_window):
        # Release the grab and close the pop-up window
        pop_up_window.grab_release()
...
class PassMenuBar(tk.Menu):
    ...
    def __init__(self, controller, frame):
        ...
        self.menubar.add_command(
            label="Settings", state="disabled", command=self.settings_clicked
        )
